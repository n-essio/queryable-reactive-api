...
public abstract class RsResponseServiceReactive implements Serializable {
    ...
    public static Uni<Response> getResponseUni(Response response) {
        return Uni.createFrom().item(response);
    }

    // Return the object passed as a reply, sending it as a string
